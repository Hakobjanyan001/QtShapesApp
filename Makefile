#############################################################################
# Makefile for building: mini-canvas
# Generated by qmake (3.1) (Qt 6.4.2)
# Project:  mini-canvas.pro
# Template: app
# Command: /usr/bin/qmake6 -o Makefile mini-canvas.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = mini-canvas1.0.0
DISTDIR = /home/hakobjanyan/QtShapesApp/.tmp/mini-canvas1.0.0
LINK          = g++
...
DIST          = /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		...
		mini-canvas.pro include/mainwindow.h \
		include/shapefactory.h \
		include/shape.h \
		include/circle.h \
		include/rectangle.h \
		include/triangle.h main.cpp \
		src/mainwindow.cpp \
		src/shapefactory.cpp \
		src/circle.cpp \
		src/rectangle.cpp \
		src/triangle.cpp
QMAKE_TARGET  = mini-canvas
DESTDIR       = 
TARGET        = mini-canvas
...
mini-canvas: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: mini-canvas.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile mini-canvas.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/mainwindow.h include/shapefactory.h include/shape.h include/circle.h include/rectangle.h include/triangle.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp src/mainwindow.cpp src/shapefactory.cpp src/circle.cpp src/rectangle.cpp src/triangle.cpp $(DISTDIR)/
...
shapefactory.o: src/shapefactory.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o shapefactory.o src/shapefactory.cpp

circle.o: src/circle.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o circle.o src/circle.cpp

rectangle.o: src/rectangle.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o rectangle.o src/rectangle.cpp
